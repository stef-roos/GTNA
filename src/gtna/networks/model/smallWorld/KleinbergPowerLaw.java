...
public class KleinbergPowerLaw extends NetworkImpl {
	...
	private int SHORT_RANGE_CONTACTS;
	 ...
	 double EXPONENT, int CUTOFF,
	 boolean BIDIRECTIONAL, boolean RANDOM, RoutingAlgorithm ra, Transformation[] t) {
	 super("POWER_LAW", nodes,
	 new String[] { "SHORT_RANGE_CONTACTS", 
	 "EXPONENT", "CUTOFF", "BIDIRECTIONAL", "RANDOM" }, new String[] {
	 "" + SHORT_RANGE_CONTACTS, 
	 "" + EXPONENT, "" + BIDIRECTIONAL, "" + RANDOM }, ra, t);
	 ...
	 * (this.SHORT_RANGE_CONTACTS * 2 + norm)));
	 ...
	 private void generateLongRangeContacts(double sum, RingPartitionSimple[] part,
				int nr, Random rand, Edges edges, int degree) {
