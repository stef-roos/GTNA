...
public class PastryIdentifierSpace implements BIIdentifierSpace {
	...
	private PastryPartition[] partitions;

	public PastryIdentifierSpace() {
		this.bits = 0;
	...
	public void setPartitions(Partition<BigInteger>[] partitions) {
		this.partitions = (PastryPartition[]) partitions;
	}

	@Override
	public BIIdentifier randomID(Random rand) {
		return PastryIdentifier.rand(rand, this);
	}
	...
	public boolean write(String filename, String key) {
		...
		// PARTITIONS
		int index = 0;
		for (PastryPartition p : this.partitions) {
	...
	public void read(String filename, Graph graph) {
		...
		this.partitions = new PastryPartition[partitions];
		...
		while ((line = fr.readLine()) != null) {
			...
			this.partitions[index] = new PastryPartition(temp[1], this);
		}
