 ...
 *
 * ---------------------------------------
 * EigenvectorCentralityNSUpdate.java
 * ---------------------------------------
 * (C) Copyright 2009-2011, by Benjamin Schiller (P2P, TU Darmstadt)
 * and Contributors 
 *
 ...
 *
 */
public class EigenvectorCentralityNSUpdate extends NodeSorterUpdate{
	 ...
	 * @param mode
	 */
	public EigenvectorCentralityNSUpdate() {
		super("EIGENVECTOR-UPDATE", NodeSorter.NodeSorterMode.DESC);
	...
	public void setNumRuns(int numRuns) {
		...
		*/
		...
		for (int k = 0; k < N; k++) {
			if (removed[k]){
				centralities[k] = Double.MAX_VALUE;
			}else {
		if (max != 0) {
