 ...
 *
 */
public abstract class EmbeddingNodeLog extends AttackableEmbeddingNode {
	private double offered;
	private double random;

	public EmbeddingNodeLog(int index, Graph g){
		super(index,g);
	}
	...
	public void setOffered(double offer){
		this.offered = offer;
	}
