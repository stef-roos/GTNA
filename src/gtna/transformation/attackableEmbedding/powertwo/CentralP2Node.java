 ...
 *
 */
public class CentralP2Node extends SimpleP2Node {
	 ...
	 * @param ptv
	 */
	public CentralP2Node(int index, Graph g, PowerTwoVar ptv) {
		super(index, g, ptv);
	...
	public void turn(Random rand) {
		...
		countOld = countOld + Math.min(plus, minus);
		...
		minus = 0;
		 double newID = rand.nextDouble();
			...
			countNew = countNew + Math.min(plus, minus);
