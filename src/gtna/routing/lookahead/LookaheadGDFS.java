 ...
 *
 */
public class LookaheadGDFS extends RoutingAlgorithm {
	...
	public LookaheadGDFS(int ttl, ViaSelection viaSelection, double greedy, boolean include, boolean closerVia) {
